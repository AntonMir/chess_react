...
/**
 * Класс - конструктор для доски
 */
export class Board {
    cells: Cell[][] = []

    /**
     * Инициализация новой доски (или пересоздание)
     */
    public initCells() {
        for (let i = 0; i < 8; i++) {
            const row: Cell[] = []
    ...
    /**
     * Метод позволяет удобнее раставлять фигуры на доске
     */
...
// new Bishop(Colors.WHITE, this.getCell(2, 4))